...
const modules: Module[] = [
  ...
  },
  {
    ...
    faqs: [
      { q: 'お酒が飲めなくても参加できますか？', a: 'アルコールメニューメインですが、ソフトドリンクもあります。事前にご連絡いただければノンアルコールカクテルもご用意できます。' },
  ...
  },
  {
    ...
    price: '500円',
    description:
      '気になるテーマについて、ゆるやかに言葉を置いていく場です。議論でも、勉強会でもありません。\n\n正解を出す必要はありません。「なんとなくそう思う」程度の言葉でも、場に出すことで何かが動くことがあります。自分の考えが整理されたり、思いがけない角度の言葉に出会ったり。\n\n気になった書籍や記事、トピックをお持ちください。毎週土曜に開催予定。',
    faqs: [
      { q: '知識がなくても参加できますか？', a: 'できます。知識よりも、その場で感じたことや素直な疑問の方が、むしろ場を豊かにします。' },
